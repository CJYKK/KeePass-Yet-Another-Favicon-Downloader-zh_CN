...
namespace YetAnotherFaviconDownloader
{
    public sealed class YetAnotherFaviconDownloaderExt : Plugin
    {
        ...
        public override bool Initialize(IPluginHost host)
        {
            ...
            entryDownloadFaviconsItem = new ToolStripMenuItem("下载图标(&F)", menuImage, DownloadFaviconsEntry_Click);
            entryDownloadFaviconsCustomItem = new ToolStripMenuItem("下载图标(自定义下载源)(&F)", menuImage, DownloadFaviconsCustomEntry_Click);
            ...
            groupDownloadFaviconsItem = new ToolStripMenuItem("下载图标(递归)(&v)", menuImage, DownloadFaviconsGroup_Click);
            groupDownloadFaviconsCustomItem = new ToolStripMenuItem("下载图标(自定义下载源)(递归)(&v)", menuImage, DownloadFaviconsCustomGroup_Click);
            ...
            toolsSubItemsPrefixURLsItem = new ToolStripMenuItem("自动在网址前添加 http(s):// 前缀", null, PrefixURLsMenu_Click);  // TODO: i18n?
            toolsSubItemsPrefixURLsItem.Checked = Config.GetAutomaticPrefixURLs();

            // Use title field if URL field is empty
            toolsSubItemsTitleFieldItem = new ToolStripMenuItem("若网址字段为空，则使用标题字段", null, TitleFieldMenu_Click);  // TODO: i18n?
            toolsSubItemsTitleFieldItem.Checked = Config.GetUseTitleField();

            // Update last modified date when adding/updating icons
            toolsSubItemsUpdateModifiedItem = new ToolStripMenuItem("更新条目的最后修改时间", null, LastModifiedMenu_Click);  // TODO: i18n?
            ...
            toolsSubItemsMaximumIconSizeItems = new ToolStripMenuItem("最大图标尺寸", (Image)pluginHost.Resources.GetObject("B16x16_Edit"), toolsMaxIconSizeSubItems.ToArray());  // TODO: i18n?
